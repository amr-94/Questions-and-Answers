...
<div class="card mb-3">
    <div class="card-body">
       <h5 class="card-title">{{ $question->title }}</h5>
        <div class="text-muted mb-4">Asked Since : {{ $question->created_at->format('d/m/y H:i A ')  }} ,
          ...
          <br>   By : <a href="{{ route('show.user',$question->user->id) }}" style="text-decoration: none">{{ $question->user->name }} </a> </div>
             ...
             <div class="card mb-3">
                <div class="card-body">
                            ...
                            <p class="card-text">{{ $answer->description }}</p>
                             <div class="text-muted mb-4">Answered Since : {{ $answer->created_at->diffforhumans()  }} , By : <a href="{{ route('show.user',$answer->user->id) }}" style="text-decoration: none"> {{ $answer->user->name }}</a> </div>
                              </div>
                          <div class="card-body">
                  ...
                  @endforelse
                    @guest
                         ...
                         <div class=" md-3">
                             <p class="">login or register to answer <a href="{{  route('login') }}" style="text-decoration: none">login</a>
                            <a href="{{ route('register') }}"  style="text-decoration: none">Register</a></p>
    ...
    <div class="card mb-3">
           <div class="card-body">
               ...
               <div class="form-group">
               <button type="submit" class="btn btn-primary mt-3 mb-2"> Add Answer</button> </div>
            </form>
                         @endif
