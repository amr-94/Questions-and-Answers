...
<div class="row">
        ...
        <div class="col-md-9" style="text-align: center">
            ...
            <div class="card mb-3">
                 <div class="card-body">
                       <h5 class="card-title">Title :<a href="{{ route('questions.show',$question->id) }}" style="text-decoration: none"> {{ $question->title }} </a></h5>
                       <div class="text-muted mb-4">Asked Since : {{ $question->created_at->format('d/m/y H:i A ')  }} ,By {{ $question->user->name }} , Answers : {{ $question->answers()->count() }} , Qusetion Status : {{ $question->status }} to answer</div>
